...
% zeroing-neurodynamics (ZNN) solver and online Jacobian estimation.
%
% Requirements:
%   1. MATLAB.
...
%   1. All simulation, MPC, ZNN, constraint, and Jacobian-estimation
...
%% Preallocate states and data logs
...
%% ZNN solver settings
lambda_zn = 0.1;           % ZNN convergence-rate parameter
max_iterations = 10;
solver_tolerance = 1e-8;
delta_regularization = 1e-8;

%% Online Jacobian-estimation settings
tau1 = 1/(200*pi);
tau2 = 1/(200*pi);
...
for k = 1:num_steps
    ...
    % Current end-effector pose and tracking error.
    ...
    % Predicted current-pose and desired-pose sequences.
    ...
    % Baseline joint velocity used to construct B and A.
    if k == 1
...
%% Tracking-error metrics and backward-compatible outputs
